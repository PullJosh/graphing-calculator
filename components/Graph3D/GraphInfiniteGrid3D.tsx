...
// From https://github.com/theatre-js/theatre/blob/9b4aa4b0e0ee205389cfc9685f200ce64fa09f3d/packages/r3f/src/extension/InfiniteGridHelper/index.ts
...
export function GraphInfiniteGrid3D() {
  const grid = useMemo(
    () =>
